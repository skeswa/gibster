...
class TestSyncErrorHandling:
    ...
    def test_sync_error_handling_logic(self):
        ...
        for error_msg, expected_user_msg in error_scenarios:
            ...
            if (
                ...
                "browser" in error_message.lower()
                or "playwright" in error_message.lower()
            ):
                user_friendly_error = (
                    "Browser automation error. Please contact support."
                )
            elif (
    ...
    def test_empty_error_message_handling(self):
        ...
        assert (
            user_friendly_error
            == "Failed to decrypt Gibney credentials. Please update your login information."
        )
