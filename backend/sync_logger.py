...
class SyncJobLogger:
    ...
    def log_timing(self, operation: str, start_time: datetime, **kwargs: Any) -> None:
        ...
        self._create_log_entry(
            "INFO", f"{operation} completed in {duration:.2f} seconds", details
        )
    ...
    def log_scraper_event(
        ...
        **kwargs: Any,
        ...
        details = {"event_type": event_type, "url": url, "selector": selector, **kwargs}
    ...
    def log_booking_processed(
        ...
        **kwargs: Any,
        ...
        self._create_log_entry("INFO", f"Booking {booking_name} {action}", details)
