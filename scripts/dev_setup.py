...
def check_node_version():
    ...
    try:
        ...
        major_version = int(version_str[1:].split('.')[0])  # Remove 'v' prefix and get major version
        if major_version < 14:
...
def print_next_steps(frontend_setup_success):
    ...
    print("   python -c \"from app.worker import sync_scrape_all_users; sync_scrape_all_users()\"")
